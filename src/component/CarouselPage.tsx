...
import {carouselStyles} from "../style/carousel";
...
const CarouselPage = () => {
    ...
    const sliderControl = (isLeft: boolean | null) => (
        <button
            type="button"
    ...
    return (
        ...
        <div className=" p-12 flex justify-center w-screen sm items-center shadow-md">
