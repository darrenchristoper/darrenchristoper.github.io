...
const $$Jumbotroncontact = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Jumbotroncontact;
  return renderTemplate`${maybeRenderHead()}<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Im here to connect</h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">If you guys need to contact me, down below is my social media</p>
...
}, "C:/Users/Darren_Christoper/darrenchristoper.github.io/src/astropage/jumbotroncontact.astro");
...
${renderComponent($$result, "Jumbotron", $$Jumbotroncontact, {})}
